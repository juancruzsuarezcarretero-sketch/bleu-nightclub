      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 lg:grid-cols-2">
        <FadeIn>
          ...
          <p className="mt-4 font-mono text-sm leading-relaxed text-[#F0F0F0]/60">
            Desde 2018, redefinimos la experiencia nocturna en el corazón de la
            ciudad. Música de primer nivel, producción de lujo y el ambiente más
          ...
          <div className="mt-8 space-y-3 font-mono text-xs text-[#F0F0F0]/50">
            <p>
              ...
              Sábados · 01:00 a 07:00 hs
            </p>
            <p>
              <span className="text-[#00AAFF]">Dirección:</span> Av. Marcelo T.
              de Alvear 635, Córdoba
            </p>
          </div>
